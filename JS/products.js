let productos = [
    ...
    },
    {
      ...
      },
      {
        id: 12,
        name: "Ibias",
        description: "Tubérculos similares a la papa, de sabor suave y textura firme.",
      ...
      },
      {
        id: 25,
        name: "Guayaba",
        description: "Fruta tropical, dulce y aromática, ideal para jugos y postres.",
      ...
      },
      {
        ...
        description: "Arepas de maíz amarillo, rellenas o acompañadas de queso y cuajada.",
      ...
      },
      {
        ...
        description: "Duraznos enteros en un suave almíbar, perfectos para postres o como acompañamiento.",
      ...
      },
      {
        ...
        description: "Mermelada elaborada con feijoas frescas, ideal para untar o como ingrediente en recetas.",
      ...
      },
      {
        ...
        description: "Chocolate hecho con cacao de la región, perfecto para bebidas y postres.",
      ...
      },
      {
        id: 37,
        name: "Chunchullo",
        description: "Tripa de res asada, típica en platos tradicionales de la región.",
      ...
      },
      {
        id: 38,
        name: "Longaniza",
        description: "Embutido tradicional, ahumado y sazonado con especias locales.",
      ...
      },
      {
        id: 46,
        name: "Habas",
        description: "Legumbres verdes y nutritivas, comunes en platos tradicionales.",
...
function agregarAlCarrito(productId) {
  ...
  if (producto) {
    ...
    actualizarSidebar();
    toggleSidebar(); // Abre la sidebar automáticamente
  }
}
...
// Evento para abrir/cerrar la sidebar
